...
x.files=c( "Dem75mInteger_100_no"
           ,"MinTemp_Jul_100_no"
           ,"MaxTemp_Jan_100_no"
...
w.files=c("distance_to_roads_100_no","terrain_ruggedness_index_sept2012_100_no" )
...
pb=read.csv("yb-pb-location.csv")
