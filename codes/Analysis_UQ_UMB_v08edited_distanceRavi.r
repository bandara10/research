...
acsel <- gridSample(acsel, mydata.r, n = 3)
...
writeRaster( lot_density.crop,"raster_crop\\ lot_density.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(lot_density.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)
-------------------------------------------------------------------------------------------------------
  roaden21.r <- raster("raster\\roaden21.tif")
projection(roaden21.r) <- CRS("+init=epsg:4326")
# Reproject to MGA-56:
roaden21.r <- projectRaster(from = roaden21.r, crs = CRS("+init=epsg:28356"))
windows(); plot(roaden21.r, axes = TRUE)
# Create an empty raster of appropriate dimensions. Remind ourselves of the dimensions of mydata.r which we created earlier:
mydata.r
#r <- raster(ncol = 33, nrow = 33)
#extent(r) <- extent(mydata.r)
# Crop the raster to the shape file spatial extent:
roaden21.crop <- crop(x = roaden21.r, y = r, snap = "near")
windows(); plot(roaden21.crop)
writeRaster( roaden21.r,"raster_crop\\ roaden21.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(roaden21.r)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)
...
# Resample:
twi.r <- resample(x = twi.crop, y = r)
writeRaster( unclassified.crop,"raster_crop\\ RDunclassified.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(unclassified.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)
...
writeRaster( track.crop,"raster_crop\\ RDtrack.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(track.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)
...
writeRaster( trunck.crop,"raster_crop\\ RDtrunck.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(trunck.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)
...
writeRaster( motorwaylink.crop,"raster_crop\\ RDmotorwaylink.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(motorwaylink.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)
...
writeRaster( motorway.crop,"raster_crop\\ RDmotorway.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(motorway.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)
...
writeRaster( tertiary_liink.crop,"raster_crop\\ RDtertiary_liink.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(tertiary_liink.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)
...
writeRaster( tertiary.crop,"raster_crop\\ RDtertiary.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(tertiary.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)
...
writeRaster( secondry.crop,"raster_crop\\ RDsecondry.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(secondry.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( roads_other.crop,"raster_crop\\ RDroads_other.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(roads_other.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( residential.crop,"raster_crop\\ RDresidential.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(residential.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE) 
...
writeRaster( primary.crop,"raster_crop\\ RDprimary.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(primary.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE) 
...
writeRaster( pedestrian.crop,"raster_crop\\ RDpedestrian.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(pedestrian.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE) 
...
writeRaster( path.crop,"raster_crop\\ RDpath .TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(path.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE) 
...
writeRaster( cycle.crop,"raster_crop\\ RDcycle.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(cycle.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE) 
...
writeRaster( bridle.crop,"raster_crop\\ RDbridle.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(bridle.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE) 
...
writeRaster( distance_pedestrian.crop,"raster_crop\\ distance_pedestrian.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_pedestrian.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_service.crop,"raster_crop\\ distance_service.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_service.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_bridleway.crop,"raster_crop\\ distance_bridleway.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_bridleway.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_cycleway.crop,"raster_crop\\ distance_cycleway.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_cycleway.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_path.crop,"raster_crop\\ distance_path.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_path.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_steps.crop,"raster_crop\\ distance_steps.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_steps.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_residentil.crop,"raster_crop\\ distance_residentil.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_residentil.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_unclassified.crop,"raster_crop\\ distance_unclassified.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_unclassified.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_tertiaryandlink.crop,"raster_crop\\ distance_tertiaryandlink.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_tertiaryandlink.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_secondaryandlink.crop,"raster_crop\\ distance_secondaryandlink.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_secondaryandlink.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_primaryandlink.crop,"raster_crop\\ distance_primaryandlink.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_primaryandlink.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_motorwayandlink.crop,"raster_crop\\ distance_motorwayandlink.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_motorwayandlink.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_trunkandlink.crop,"raster_crop\\ distance_trunkandlink.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_trunkandlink.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
writeRaster( distance_track.crop,"raster_crop\\ distance_track.TIF", overwrite=TRUE)
# Plot to check:
windows(); plot(distance_track.crop)
points(acsel, cex = 0.4, col = 'red', pch = 15)
plot(mydata.p, add = TRUE)  
...
windows();plot(dat.w)
# set the dimensions for the grid and the bandwidth:enables and Ripley (2002), grid is about the number of points that kernel density is estimated on:
dimyx = c(200,200)
bandwidth <- 2000
...
breaks <- seq(from = 0.0, to = 0.009, length = 5)
...
-------------------------------------------------------------------------------------------------------------------------
  ...
  roaden21.im <- as.im(roaden21.r )
windows(); plot(roaden21.im, axes = TRUE)

# What is the nature of the association between koala sight locations and total phosphorous?
roaden21.rho <- rhohat(object = dat.ppp, covariate = roaden21.im)
windows(); plot(roaden21.rho, xlab = "roaden21 road density (units)", main = "")
savePlot(filename = "roaden21RD",type = c( "png"),device = dev.cur())
 --------------------------------------------------------------------------------------------------
  #rhohat for road densities. and distace to roads follows.
...
myvariables=("tpo.r, awc.r, fpc.r, sbd.r, clay.r, water.r, nitro.r, roaden.r, hpop.r,
             rain.r,  temp.r, elev.r, topo.r,slope.r,aspect.r,twi.r,habitat=habit.r, habit1.r,habit2.r, habit3.r")
# Null model:
dat.ppm00 <- ppm(dat.ppp, trend = ~ 1, covariates = list(fpc= fpc.im, awc= awc.im, topo=topo.im, slope=slope.im, aspect=aspect.im,twi=twi.im, tpo = tpo.im, sbd = sbd.im,  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
summary(dat.ppm00)$coefs.SE.CI
AIC(dat.ppm00) # 3635.185
windows();plot(dat.ppp)

# Backward stepwise variable selection:
dat.ppm01 <- ppm(dat.ppp, trend = ~ fpc + awc + topo + slope + aspect + twi + tpo + sbd + water + nitro + roaden + hpop + temp + elev + habit01 + habit02 + habit03,
...
dat.ppm02 <- ppm(Qz, trend = ~ fpc +topo + slope + aspect + twi + tpo+roaden + hpop + temp + elev + habit01 + habit02 + habit03,
                 covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                  habit02 = habit02.im, habit03 = habit03.im))
summary(dat.ppm02)$coefs.SE.CI
tdat <- data.frame(summary(dat.ppm02)$coefs.SE.CI); tdat[order(tdat$Zval),]
AIC(dat.ppm02) # 3606.057
-----------------------------------------------------------------------------------------------------------------
...
plot(dat.ppm02, main = "realisation of fitted model") # simulating the fitted model.

dat.ppm21 <- ppm(Qz, trend = ~ fpc  + temp + elev, covariates =list(fpc= fpc.im, temp = temp.im, elev = elev.im))
summary(dat.ppm21)$ coefs.SE.CI
tdat <- data.frame(summary(dat.ppm21)$coefs.SE.CI); tdat[order(tdat$Zval),]
----------------------------------------------------------------------------------------------------------------------

# Drop topo + 
  dat.ppm03 <- ppm(Qz, trend = ~ fpc +slope + aspect + twi + tpo+roaden + hpop + temp + elev + habit01 + habit02 + habit03,
                   covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                    water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                    habit02 = habit02.im, habit03 = habit03.im))
...
AIC(dat.ppm03) # 3605.266


# Drop habitat03: + habit03
dat.ppm04 <- ppm(Qz, trend = ~ fpc +slope + twi + tpo+roaden + hpop + temp + elev + habit01 + habit02 + habit03,
                 covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                  habit02 = habit02.im, habit03 = habit03.im))
...
# Drop  tpo+ + :
dat.ppm05 <- ppm(Qz, trend = ~ fpc + slope + aspect + twi +hpop + temp + elev + habit01 + habit02,
                 covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                  habit02 = habit02.im, habit03 = habit03.im))
summary(dat.ppm05)$coefs.SE.CI
tdat <- data.frame(summary(dat.ppm05)$coefs.SE.CI); tdat[order(tdat$Zval),]
AIC(dat.ppm05) # 3599.624


# Drop habit01
dat.ppm06 <- ppm(Qz, trend = ~ fpc + slope + aspect + twi +hpop + temp + elev +habit02,
                 covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                  habit02 = habit02.im, habit03 = habit03.im))
...
# Drop hpop + 
dat.ppm07 <- ppm(Qz, trend = ~ fpc + slope + aspect + twi +temp + elev +habit02,
                 covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                  habit02 = habit02.im, habit03 = habit03.im))
summary(dat.ppm07)$coefs.SE.CI
tdat <- data.frame(summary(dat.ppm07)$coefs.SE.CI); tdat[order(tdat$Zval),]
AIC(dat.ppm07) # 3598.784


# Drop  aspect + :
dat.ppm08 <- ppm(Qz, trend = ~ fpc + slope + twi +temp + elev +habit02,
                 covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                  habit02 = habit02.im, habit03 = habit03.im))
...
# Drop twi +
dat.ppm09 <- ppm(Qz, trend = ~ fpc + slope + temp + elev +habit02,
                 covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                  habit02 = habit02.im, habit03 = habit03.im))
...
# Drop  + twi 
dat.ppm10 <- ppm(Qz, trend = ~ fpc + temp + elev +habit02,
                 covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                  habit02 = habit02.im, habit03 = habit03.im))
...
#Drop  + slope 
dat.ppm11 <- ppm(Qz, trend = ~ fpc + temp + habit02,
                 covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                  habit02 = habit02.im, habit03 = habit03.im))
...
savePlot(filename = "datppm11",type = c( "png"),device = dev.cur())

# Now add a Strauss spatial interaction term:
dat.ppm05<- ppm(Qz, trend = ~ fpc +slope + twi + tpo+roaden + hpop + temp + elev + habit01 + habit02 + habit03,interaction = Strauss(r = 6000),
                 covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                  water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                  habit02 = habit02.im, habit03 = habit03.im))
...
summary(dat.ppm05)$coefs.SE.CI
AIC(dat.ppm05) # 2459.733

windows(); plot(dat.ppm05, how = "image", se = TRUE)
windows(); diagnose.ppm(dat.ppm05, type = "raw")


# Drop   +temp 
dat.ppm06<- ppm(Qz, trend = ~ fpc +slope + twi + tpo+roaden + hpop +  elev + habit01 + habit02 + habit03,interaction = Strauss(r = 6000),
                covariates =list(fpc= fpc.im, awc= awc.im, topo = topo.im, slope = slope.im, aspect = aspect.im, twi=twi.im, tpo = tpo.im, sbd = sbd.im,  
                                 water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im,
                                 habit02 = habit02.im, habit03 = habit03.im))
...
AIC(dat.ppm06) # 2459.733

windows(); plot(dat.ppm06, how = "image", se = TRUE)
windows(); diagnose.ppm(dat.ppm06, type = "raw")


# Drop + habit02
dat.ppm14 <- ppm(Qz, trend = ~ fpc +temp,interaction = Strauss(r = 6000), 
...
dat.pred04 <- predict(dat.ppm04); pred <- dat.pred04
...
breaks <- seq(from = 0, to = 0144  , length = 5)
...
breaks <- seq(from = 0, to = 0.02, length = 5)
col <- brewer.pal(n = 4, name = "Blues")
