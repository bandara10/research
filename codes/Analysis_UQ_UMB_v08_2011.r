...
breaks <- seq(from = 0, to = 0.008, length = 5)
...
AIC(dat.ppm02) # 5982.371


# Drop hpop:
dat.ppm03 <- ppm(Qz, trend = ~ tpo + sbd + water + nitro + roaden + temp + elev + habit01 + habit02 + habit03, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
summary(dat.ppm03)$coefs.SE.CI
tdat <- data.frame(summary(dat.ppm03)$coefs.SE.CI); tdat[order(tdat$Zval),]
AIC(dat.ppm03) # 5980.371


# Drop nitro:
dat.ppm04 <- ppm(Qz, trend = ~ tpo + sbd + water +roaden + temp + elev + habit01 + habit02 + habit03, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
summary(dat.ppm04)$coefs.SE.CI
tdat <- data.frame(summary(dat.ppm04)$coefs.SE.CI); tdat[order(tdat$Zval),]
AIC(dat.ppm04) # 5978.442


# Drop habit1:
dat.ppm05 <- ppm(Qz, trend = ~ tpo + sbd + water +roaden + temp + elev +habit02 + habit03, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
...
# Drophabit03:
dat.ppm06 <- ppm(Qz, trend = ~ tpo + sbd + water +roaden + temp + elev +habit02, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
summary(dat.ppm06)$coefs.SE.CI
tdat <- data.frame(summary(dat.ppm06)$coefs.SE.CI); tdat[order(tdat$Zval),]
AIC(dat.ppm06) # 5975.808
--------------------------------------------------------
...
dat.ppm11 <- ppm(Qz, trend = ~ tpo + sbd + water +roaden + temp + elev +habit02, interaction = Strauss(r = 6000), 
