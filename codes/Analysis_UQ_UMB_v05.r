...
studyarea.shp <- readShapePoly("AU_Qld_study_area-MGA56a.shp, Mark_S\\AU_Qld_study_area)
...
elev.r <- raster("C:\\Users\\uqrdissa\\ownCloud\\Covariates_analysis\\elevation.asc")
...
hpop.r <- raster("C:\\Users\\uqrdissa\\ownCloud\\Covariates_analysis\\hpop.asc")
...
windows(); plot(hpop.rho, xlim = c(0, 5000), ylim = c(0, 0.7e-06), xlab = "Human population density", main = "")


# ---------------------------------------------------------------------------------------------------------------------------------
# rhohat analyses - annual rainfall (mm):

rainfall.r <- raster("C:\\Users\\uqrdissa\\ownCloud\\Covariates_analysis\\rainfall.asc")
...
unzip("C:\\Users\\uqrdissa\\ownCloud\\Covariates_analysis\\Mark_S\\AU_Qld_study_area_mask_roads.zip")
...
windows(); plot(roads.rho,xlim = c(0, 12000), xlab = "Distance to the nearest road (m)", main = "")
...
unzip("C:\\Users\\uqrdissa\\ownCloud\\Covariates_analysis\\Mark_S\\AU_Qld_koala_habitat_suitability.zip")
habitat.shp <- readShapePoly("AU_Qld_koala_habitat_suitability_study_area-MGA56.shp")
proj4string(habitat.shp) <- CRS("+init=epsg:28356") 
