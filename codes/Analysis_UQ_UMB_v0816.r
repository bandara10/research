...
#load(file = "D:\\Contracts\\Australia\\UQ\\Koalas\\data\\AU_Qld_koala_habitat_v07.RData")
...
myInPtDF2 = subset(myInPtDF, myInPtDF$disttoitself > 300)
...
sbd.r <- raster("D:\\Contracts\\Australia\\UQ\\Koalas\\raster\\AU_Qld_soil_bulk_density_000_005cm-wgs84.tif")
...
clay.r <- raster("D:\\Contracts\\Australia\\UQ\\Koalas\\raster\\AU_Qld_soil_clay_000_005cm-wgs84.tif")
...
water.r <- raster("D:\\Contracts\\Australia\\UQ\\Koalas\\raster\\AU_Qld_soil_available_water_capacity_000_005cm-wgs84.tif")
...
nitro.r <- raster("D:\\Contracts\\Australia\\UQ\\Koalas\\raster\\AU_Qld_soil_nitrogen_000_005cm-wgs84.tif")
...
unzip("D:\\Contracts\\Australia\\UQ\\Koalas\\vector\\AU_Qld_road_length.zip")
...
hpop.r <- raster("D:\\Contracts\\Australia\\UQ\\Koalas\\raster\\AU_Qld_hpop-MGA65.asc")
...
rain.r <- raster("D:\\Contracts\\Australia\\UQ\\Koalas\\raster\\AU_Qld_rainfall-MGA65.asc")
...
temp.r <- raster("D:\\Contracts\\Australia\\UQ\\Koalas\\raster\\AU_Qld_temp-MGA65.asc")
...
elev.r <- raster("D:\\Contracts\\Australia\\UQ\\Koalas\\raster\\AU_Qld_dem-MGA65.asc")
...
unzip("D:\\Contracts\\Australia\\UQ\\Koalas\\vector\\AU_Qld_koala_habitat_suitability.zip")
...
save.image("AU_Qld_koala_habitat_v07.RData")
...
# Null model:
dat.ppm00 <- ppm(dat.ppp, trend = ~ 1, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im,  hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
...
# Drop tpo:
dat.ppm03 <- ppm(Qz, trend = ~ sbd + water + nitro + roaden + hpop + temp + elev + habit01 + habit02 + habit03, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
summary(dat.ppm03)$coefs.SE.CI
tdat <- data.frame(summary(dat.ppm03)$coefs.SE.CI); tdat[order(tdat$Zval),]
AIC(dat.ppm03) # 3462.463


# Drop habitat03:
dat.ppm04 <- ppm(Qz, trend = ~ sbd + water + nitro + roaden + hpop + temp + elev + habit01 + habit02, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
...
# Drop water:
dat.ppm05 <- ppm(Qz, trend = ~ sbd + nitro + roaden + hpop + temp + elev + habit01 + habit02, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
...
# Drop hpop:
dat.ppm06 <- ppm(Qz, trend = ~ sbd + nitro + roaden + temp + elev + habit01 + habit02, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
...
# Drop roaden:
dat.ppm07 <- ppm(Qz, trend = ~ sbd + nitro + temp + elev + habit01 + habit02, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
...
# Drop nitro:
dat.ppm08 <- ppm(Qz, trend = ~ sbd + temp + elev + habit01 + habit02, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
...
# Drop habit01:
dat.ppm09 <- ppm(Qz, trend = ~ sbd + temp + elev + habit02, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
...
# Drop elev:
dat.ppm10 <- ppm(Qz, trend = ~ sbd + temp + habit02, covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
summary(dat.ppm10)$coefs.SE.CI
AIC(dat.ppm10) # 3454.587
...
dat.ppm11 <- ppm(Qz, trend = ~ sbd + temp + habit02, interaction = Strauss(r = 6000), 
...
# Drop habit02:
dat.ppm12 <- ppm(Qz, trend = ~ sbd + temp, interaction = Strauss(r = 6000), 
   covariates = list(tpo = tpo.im, sbd = sbd.im, water = water.im, nitro = nitro.im, roaden = roaden.im, hpop = hpop.im, temp = temp.im, elev = elev.im, habit01 = habit01.im, habit02 = habit02.im, habit03 = habit03.im))
