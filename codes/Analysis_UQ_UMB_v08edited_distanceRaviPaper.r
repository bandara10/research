...
names(mydata)
mydata <- subset(mydata, yearnew < 2000) #select 1997-1999/ then yearnew>=2000|yearnew<2003
...
res(mydata.r) <- 1000
mydata.r <- extend(mydata.r, extent(441829, 541829, 6900098, 7002098) + 1000)#extenet should be similar to the selected area not the full dataset
