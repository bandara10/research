...
unzip("D:\\Contracts\\Australia\\UQ\\Koalas\\vector\\AU_Qld_study_area.zip")
...
tpo.r <- raster("D:\\Contracts\\Australia\\UQ\\Koalas\\raster\\AU_Qld_soil_total_phosphorous_000_005cm-wgs84.tif")
...
breaks <- seq(from = 0, to = 1.31400, length = 5)
...
breaks <- seq(from = 0, to = 0.003, length = 5)
col <- brewer.pal(n = 4, name = "Blues")
